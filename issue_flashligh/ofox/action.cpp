                ...
                if (!path_one.empty()) {
                        ...
                        if (TWFunc::Path_Exists(bright_one)) {
                                ...
                                if (fl_one_on == "0" || fl_used == "0") {
                                        TWFunc::write_to_file(
                                                bright_one,
                                                (max_brt_one == "0" || max_brt_one == "1") ? "2" : max_brt_one
                                        );
                                        DataManager::SetValue("of_flash_on", "1");
                                } else {
                                        TWFunc::write_to_file(bright_one, "1");
                ...
                if (!path_two.empty()) {
                        ...
                        if (TWFunc::Path_Exists(bright_two)) {
                                ...
                                if ((fl_two_on == "0" && fl_one_on == "0") || fl_used == "0") {
                                        TWFunc::write_to_file(
                                                bright_two,
                                                (max_brt_two == "0" || max_brt_two == "1") ? "2" : max_brt_two
                                        );
                                        DataManager::SetValue("of_flash_on", "1");
                                } else {
                                        TWFunc::write_to_file(bright_two, "1");
                                        DataManager::SetValue("of_flash_on", "0");
                                }
                        }
                }
